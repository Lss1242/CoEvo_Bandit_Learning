...
# Example bignum game matrix generation and running self-play experiments
if __name__ == '__main__':
    ...
    for n in nlist:
        ...
        regrets_df.to_csv(os.path.join(output_dir, f'exp3ix_selfplay_regrets_n{n}.csv'), index=False)
        tv_df.to_csv(os.path.join(output_dir, f'exp3ix_selfplay_tv_n{n}.csv'), index=False)
