...
if __name__ == '__main__':
        ...
        regrets_df.to_csv(os.path.join(output_dir, f'coebl_selfplay_regrets.csv'), index=False)
        tv_df.to_csv(os.path.join(output_dir, f'coebl_selfplay_kl_divergences.csv'), index=False)
